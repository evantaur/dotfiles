...
_get "https://raw.githubusercontent.com/evantaur/dotfiles/refs/heads/main/local/share/applications/openlink.desktop" "/tmp/openlink.desktop" && \
_get "https://raw.githubusercontent.com/evantaur/dotfiles/refs/heads/main/local/bin/openlink" "/tmp/openlink" && \
...
sed -i "s|USER_NAME|$USER_BROWSER|g" $HOME/.local/bin/openlink
